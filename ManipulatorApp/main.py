...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.ui.btn_kal_set_0.clicked.connect(lambda: UIFunctions.calibration_set(self))
        ...
        self.ui.btn_manual_pistol.clicked.connect(lambda: UIFunctions.page_manual_pistol(self))
        self.ui.btn_manual_home.clicked.connect(lambda: UIFunctions.page_manual_home(self))
        self.ui.btn_manual_reset_1.clicked.connect(lambda: AppFunctions.page_manual(self))
        self.ui.btn_manual_reset_2.clicked.connect(lambda: AppFunctions.page_manual(self))
        self.ui.btn_manual_pistol.clicked.connect(lambda: AppFunctions.page_manual(self))
        self.ui.btn_manual_home.clicked.connect(lambda: AppFunctions.page_manual(self))
